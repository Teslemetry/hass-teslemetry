...
class TeslemetryChargePortEntity(
    ...
    async def async_close_cover(self, **kwargs: Any) -> None:
        ...
        await handle_vehicle_command(
            self.hass, self.config_entry, self.api.charge_port_door_close()
        )
        self._attr_is_closed = True
        self.async_write_ha_state()
...
class TeslemetryFrontTrunkEntity(TeslemetryRootEntity, CoverEntity):
    ...
    async def async_open_cover(self, **kwargs: Any) -> None:
        ...
        await handle_vehicle_command(
            self.hass, self.config_entry, self.api.actuate_trunk(Trunk.FRONT)
        )
        self._attr_is_closed = False
        self.async_write_ha_state()
...
class TeslemetryRearTrunkEntity(TeslemetryRootEntity, CoverEntity):
    ...
    async def async_open_cover(self, **kwargs: Any) -> None:
        ...
        if self.is_closed is not False:
            ...
            await handle_vehicle_command(
                self.hass, self.config_entry, self.api.actuate_trunk(Trunk.REAR)
            )
            self._attr_is_closed = False
            self.async_write_ha_state()
...
class TeslemetryTonneauEntity(TeslemetryRootEntity, CoverEntity):
    ...
    async def async_open_cover(self, **kwargs: Any) -> None:
        ...
        await handle_vehicle_command(
            self.hass,
            self.config_entry,
            self.api.closure(tonneau=ClosureState.OPEN),
        )
        self._attr_is_closed = False
        self.async_write_ha_state()
    ...
    async def async_close_cover(self, **kwargs: Any) -> None:
        ...
        await handle_vehicle_command(
            self.hass,
            self.config_entry,
            self.api.closure(tonneau=ClosureState.CLOSE),
        )
        self._attr_is_closed = True
        self.async_write_ha_state()
    ...
    async def async_stop_cover(self, **kwargs: Any) -> None:
        ...
        await handle_vehicle_command(
            self.hass,
            self.config_entry,
            self.api.closure(tonneau=ClosureState.STOP),
        )
        self._attr_is_closed = False
        self.async_write_ha_state()
