...
VEHICLE_DESCRIPTIONS: tuple[TeslemetryNumberEntityDescription, ...] = (
    TeslemetryNumberEntityDescription(
        ...
        streaming_key=TelemetryFields.CHARGE_CURRENT_REQUEST,
    ...
    TeslemetryNumberEntityDescription(
        ...
        timestamp_key=TeslemetryTimestamp.CHARGE_STATE,
        streaming_key=TelemetryFields.CHARGE_LIMIT_SOC,
        native_step=PRECISION_WHOLE,
        native_min_value=50,
...
class TeslemetryImperialSpeedNumberEntity(TeslemetryVehicleEntity, NumberRestoreEntity):
    ...
    def __init__(
        ...
        super().__init__(data, "vehicle_state_speed_limit_mode_current_limit_mph", TeslemetryTimestamp.VEHICLE_STATE, TelemetryFields.CURRENT_LIMIT_MPH)
...
class TeslemetryMetricSpeedNumberEntity(TeslemetryVehicleEntity, NumberRestoreEntity):
    ...
    def __init__(
        ...
        super().__init__(data, "vehicle_state_speed_limit_mode_current_limit_kph", TeslemetryTimestamp.VEHICLE_STATE, TelemetryFields.CURRENT_LIMIT_MPH)
